...
abline(v=mean(df$wt[which(df$am==1)]), col="red", lty=2)
abline(v=mean(df$wt[which(df$am==0)]), col="black", lty=2)
legend("topright", pch=c(15, -1, 15, -1), legend=c("automatic", "avg wt", "manual", "avg wt"), col=c(1, 1, 2, 2), lty=c(0, 2, 0, 2), bg="white")
